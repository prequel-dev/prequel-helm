...
*/}}
{{- define "probes.name" -}}
{{- default .Chart.Name .Values.probes.fullnameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- if .Values.probes.fullnameOverride }}
{{- .Values.probes.fullnameOverride | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- $name := default .Chart.Name .Values.probes.fullnameOverride }}
{{- if contains $name .Release.Name }}
{{- .Release.Name | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- printf "%s-%s" .Release.Name $name | trunc 63 | trimSuffix "-" }}
...
{{- if .Values.probes.serviceAccount.create }}
{{- default (include "probes.fullname" .) .Values.probes.serviceAccount.name }}
{{- else }}
{{- default "default" .Values.probes.serviceAccount.name }}
{{- end }}
{{- end }}
...
{{- default .Chart.Name .Values.provision.fullnameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- if .Values.provision.fullnameOverride }}
{{- .Values.provision.fullnameOverride | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- $name := default .Chart.Name .Values.provision.fullnameOverride }}
{{- if contains $name .Release.Name }}
{{- .Release.Name | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- printf "%s-%s" .Release.Name $name | trunc 63 | trimSuffix "-" }}
